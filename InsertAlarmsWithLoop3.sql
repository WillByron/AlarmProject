...
WHEN NOT MATCHED BY TARGET THEN
    INSERT (AuditId, source, unit,Bed,Channel,Duration,TEXT,msh_ts,alarm_ts,msg_id,TimeStamp,filename,DateInserted ,alarmended,AlarmCount)
	VALUES (source.AuditId, source.source, source.unit,	source.Bed,source.Channel, source.duration 
